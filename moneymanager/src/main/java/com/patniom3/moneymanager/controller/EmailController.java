...
import com.patniom3.moneymanager.service.*;
...
public class EmailController {
    ...
    public ResponseEntity<Void> emailIncomeExcel() throws IOException, MessagingException {
        ...
        emailService.sendEmailWithAttachment(profile.getEmail(), "Your Income Excel Report", "Please find attached your income report",
                baos.toByteArray(),
                "income.xlsx");
